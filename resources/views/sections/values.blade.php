    ...
    <div class="mx-auto w-full px-2">
         <div class="flex flex-col lg:flex-row gap-8 lg:gap-12">
            ...
            <div class="lg:w-1/2 space-y-6 md:space-y-8 fade-in-left">
                ...
                <div class="space-y-4 md:space-y-6">
                    <div class="flex items-center space-x-4">
                        <span class="text-xl md:text-2xl font-bold text-white orbitron">01</span>
                        <div class="h-px bg-gray-600 flex-1"></div>
                        <span class="text-gray-400 text-xs md:text-sm orbitron">02 03 04</span>
                    </div>

                    <p class="text-gray-300 text-base md:text-lg leading-relaxed max-w-md">
                ...
                <div class="space-y-8 md:space-y-12">
                    ...
                    <h1 class="text-2xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-white leading-tight stagger-2">
                        Empowering
                        <br />
            ...
            <div class="lg:w-1/2 flex flex-col md:flex-row gap-4 h-full items-start fade-in-right">
                <!-- AI-Powered Card -->
                <div class="relative rounded-2xl md:rounded-3xl overflow-hidden h-[400px] md:h-[570px] flex-1 inset-0 bg-black bg-opacity-40 shadow-md shadow-[#D1FF75]/50 scale-in stagger-1">
                ...
                <div class="flex flex-col gap-4 md:gap-6 flex-1">
                    <!-- Time-Saving Card -->
                    <div class="relative rounded-2xl md:rounded-3xl overflow-hidden h-[350px] md:h-[500px] inset-0 bg-black bg-opacity-40 shadow-md shadow-[#D1FF75]/50 scale-in stagger-2">
                        <div class="absolute inset-0">
                            <img src="/bobbi-dashboard.png"
                    ...
                    <div class="flex justify-end space-x-4 fade-in-up stagger-3">
                        <button class="rounded-full bg-white border border-gray-200 hover:bg-gray-50 p-2 md:p-3 transition-all">
                            <svg class="h-4 md:h-5 w-4 md:w-5 text-gray-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path>
                            </svg>
                        </button>
                        <button class="rounded-full bg-[#d1ff75] text-black border border-gray-900 hover:bg-gray-800 p-2 md:p-3 transition-all">
